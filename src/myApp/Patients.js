...
function Patients() {
  ...
  useEffect(() => {
    ...
    fetch(`https://localhost/zhhs_soft_server/api/patients`, {
  ...
  }, [`https://localhost/zhhs_soft_server/api/patients`]);
    ...
    newSwal
      ...
      .then((result) => {
        if (result.isConfirmed) {
          setIsPending(true);
          setPatientsData(null);
          fetch(`https://localhost/zhhs_soft_server/api/patients/delete-patient?${sendId}`, {
            method: "POST",
