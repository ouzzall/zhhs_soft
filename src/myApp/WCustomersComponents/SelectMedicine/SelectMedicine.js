...
function SelectMedicine() {
  ...
  useEffect(() => {
    ...
    fetch(`https://localhost/zhhs_soft_server/api/medicines/separated`, {
      // method: "GET",
  ...
  }, [`https://localhost/zhhs_soft_server/api/medicines/separated`]);
  ...
  function addToTable() {
    ...
    if (medShelfKey === 0) {
      ...
      setErrorText("Medicine Quantity not defined");
      setErrorSB(true);
      // } else if (medDaz < 1) {
    ...
    <SuiBox>
      ...
      <SuiBox>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={12}>
            <SuiBox className="ovr_flow" p={1} pb={4}>
              <SuiBox className="inside_width_two">
                <Grid container spacing={3} p={1}>
                  ...
                  <Grid item xs={3} md={3} className="rit_align">
                    <SuiTypography variant="overline" fontWeight="regular" color="dark">
                      ACTION
                    </SuiTypography>
                  </Grid>
